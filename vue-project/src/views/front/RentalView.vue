<template>
  <div id="rentalView" class="relative w-full h-full flex flex-wrap justify-center items-center">
    ...
    <a href="/rental/63e25d92384dcac8bdbb00c0" class="hidden lg:block px-4 right-[500px] py-2 absolute bg-black text-white rounded-3xl">AZ劇場</a>
        <a href="/rental/63e4f0a17362e713cd1787f8" class="hidden lg:block px-4 top-[400px] right-[300px] py-2 absolute bg-black text-white rounded-3xl">展覽會館</a>
            <a href="/rental/63e4f1ab7362e713cd178801" class="hidden lg:block px-4 bottom-[350px] right-[700px] py-2 absolute bg-black text-white rounded-3xl">玻璃貨櫃屋</a>
  </div>
