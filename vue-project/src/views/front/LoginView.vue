        ...
        <div class="col">
          <div data-aos="fade-up" data-aos-duration="1500" data-aos-delay="1500" id="loginBG" class="w-full max-w-sm p-4 bg-whiteF rounded-lg sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mx-auto">
            <form class="space-y-6" action="#" @submit.prevent="login">
              ...
              <div>
                <label for="account" class="flex mb-2 text-sm font-medium text-white">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
                    ...
                    aria-hidden="true"
                    class="w-5 h-5 mr-1 text-white dark:text-gray-400">
                    <path
              ...
              <div>
                <label for="password" class="flex mb-2 text-sm font-medium text-white">
                  <svg
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
