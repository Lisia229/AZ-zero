<template>
  <div id="rentalView" class="px-4 py-4">
    <div id="rentalintro" class="px-4 pb-4">
      <h1 class="text-3xl pb-8">AZ文創園區 【場地租借辦法】</h1>
      <p class="pb-8">
        一、宗旨
        <br />
        <br />
    ...
    <div id="rentalform" class="px-4 py-4">
      ...
      <div id="rentalForm" class="flex rounded-lg shadow">
        <div class="w-1/2">
          <img class="hidden object-cover lg:block rounded-l-lg" src="../../assets/image/b01.jpg" />
        </div>
          ...
          <form class="space-y-6 py-4 px-8">
            <fieldset v-if="step === 1">
              <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="w-full">
                  <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">單位類別：</label>
                  <select
                    id="countries"
                    class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-lightpink sm:text-md focus:ring-pink-500 focus:border-pink-500">
                    <option>一般團體</option>
                ...
                <div class="w-full">
                  <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">統一編號 / 立案字號：</label>
                  <input
                    type="text"
                    id="large-input"
                    class="block w-full p-4 text-gray-900 border border-gray-300 rounded-lg bg-lightpink sm:text-md focus:ring-pink-500 focus:border-pink-500" />
