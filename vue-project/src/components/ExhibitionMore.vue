<template>
  <a class="cursor-pointer">
    ...
    <div class="lg:w-full relative mx-auto">
      <img class="mt-4 md:w-full md:h-40 lg:w-3/4 lg:h-40 rounded-lg mx-auto" :src="image" />
      <div class="p-5 row-auto items-center justify-between align-middle flex max-w-screen-xl px-4 py-4 mx-auto lg:gap-8 xl:gap-0 lg:py-4 lg:cols-2">
        ...
        <span class="hidden lg:right-0 lg:bottom-1 lg:absolute lg:flex whitespace-nowrap items-center justify-center px-3 py-1 mx-3 text-xs font-medium text-center rounded-lg bg-blueB text-white hover:bg-white hover:text-blueB hover:border-[1px] hover:border-blueB ">{{ category }}</span>
      </div>
    </div>
  </a>
</template>
